...
# Custom Streamlit Theme with a Neutral Color Palette
st.set_page_config(page_title="Curly Girl LaLa’s Market Profiler", page_icon="📊", layout="wide")

# Add a logo and personal image (replace with actual image URLs)
st.image("https://your-logo-url.com/logo.png", width=150)  # Company Logo
st.image("https://your-photo-url.com/profile.png", width=180)  # Personal Image

# Custom Title Styling with Neutral Colors
st.markdown(
    "<h1 style='text-align: center; color: #333333;'>Curly Girl LaLa’s Market Profiler</h1>",
...
st.markdown(
    "<style>"
    "div.stButton>button { background-color: #4A4A4A; color: white; border-radius: 8px; font-size: 16px; padding: 10px 20px; }"
...
# Section 1: Pain Points - Styled with a Neutral Background
st.markdown(
